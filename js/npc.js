export const DIALOGS = {
  ...
  merchant: [
    ...
    },
    {
      ...
      choices: [
        { text: 'Миф. шлем (110$)', action: 'buy_armor_mithril_helmet', next: 4 },
        { text: 'Миф. доспех (160$)', action: 'buy_armor_mithril_chest', next: 4 },
        { text: 'Миф. поножи (120$)', action: 'buy_armor_mithril_legs', next: 4 },
        { text: 'Щиты...', next: 5 },
        { text: 'Назад', next: 3 },
      ],
    },
    {
      ...
      choices: [
        { text: 'Дерев. щит (20$)', action: 'buy_armor_wooden_shield', next: 5 },
        { text: 'Жел. щит (55$)', action: 'buy_armor_iron_shield', next: 5 },
        { text: 'Огненный щит (90$)', action: 'buy_armor_fire_shield', next: 5 },
        { text: 'Миф. щит (140$)', action: 'buy_armor_mithril_shield', next: 5 },
        { text: 'Зеркальный! (200$)', action: 'buy_armor_mirror_shield', next: 5 },
        { text: 'Назад', next: 4 },
      ],
    },
  ],

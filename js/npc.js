export const DIALOGS = {
  ...
  merchant: [
    ...
    },
    {
      ...
      choices: [
        { text: 'Дерев. щит (20$)', action: 'buy_armor_wooden_shield', next: 6 },
        { text: 'Жел. щит (55$)', action: 'buy_armor_iron_shield', next: 6 },
        { text: 'Огненный щит (90$)', action: 'buy_armor_fire_shield', next: 6 },
        { text: 'Миф. щит (140$)', action: 'buy_armor_mithril_shield', next: 6 },
        { text: 'Зеркальный! (200$)', action: 'buy_armor_mirror_shield', next: 6 },
        { text: 'Назад', next: 5 },
      ],
    },
  ],

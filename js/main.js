...
import {
  ...
  checkPortals, checkCheckpoint, respawnAtCheckpoint,
} from './map-loading.js';
...
import {
  ...
  updatePlayer, updateCompanions, moveCompanionToward, MOVE_SPEED,
...
// --- Map Registry ---
// MAP_REGISTRY → вынесено в map-loading.js (Фаза 3)

// --- Player Creation ---
// createPlayer, createCompanion, COMPANION_TYPES → вынесены в player-update.js (Фаза 2)

// updateCompanions, moveCompanionToward → вынесены в player-update.js (Фаза 4)
...
// loadMap, dungeonDepth → вынесены в map-loading.js (Фаза 3)

// syncChunkEnemies, enterOpenWorld, exitOpenWorld, checkPortals, checkCheckpoint,
// respawnAtCheckpoint → все вынесены в map-loading.js (Фаза 3 Task 2.4)
...
// --- Update Player ---
// MOVE_SPEED, updatePlayer → вынесены в player-update.js (Фаза 4)
